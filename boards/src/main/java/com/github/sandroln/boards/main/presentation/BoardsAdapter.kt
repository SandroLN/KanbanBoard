...
internal open class BoardViewHolder(view: View) : ViewHolder(view) {

    open fun bind(item: BoardUi) = Unit
}

internal class BoardTitleViewHolder(view: View) : BoardViewHolder(view) {
...
internal class BoardNameViewHolder(
...
internal class BoardErrorViewHolder(
...
internal interface BoardClickListener : com.github.sandroln.core.Retry, OpenBoard

internal interface OpenBoard {
