...
import com.github.sandroln.chosenboard.R

internal class MyInvitationsView : FrameLayout {
    ...
    override fun onAttachedToWindow() {
        ...
        viewModel =
            (context.applicationContext as com.github.sandroln.core.ProvideViewModel).viewModel(
